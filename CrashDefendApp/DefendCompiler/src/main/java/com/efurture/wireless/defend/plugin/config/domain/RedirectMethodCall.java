 ...
 * */
public class RedirectMethodCall implements Serializable{

    private String className;
    private boolean includeSubClass;
    private List<DefendMethod> defendMethodList;

    public RedirectMethodCall(String className, boolean includeSubClass, List<DefendMethod> defendMethodList) {
