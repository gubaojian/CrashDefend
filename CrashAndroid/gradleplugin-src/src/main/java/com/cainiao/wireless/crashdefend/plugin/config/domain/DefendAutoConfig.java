...
public class DefendAutoConfig {
    ...
    private static void addActivity(){
        ...
        methods.add("onPostResume");
        methods.add("onPostCreate");
        methods.add("onUserLeaveHint");
        methods.add("dispatchTouchEvent");
        autoDefendClassMethods.put(defendClass, methods);
    }
    ...
    /**
     * RecyclerView.Adapter 数据绑定防护
     * */
    private static void addRecyclerViewAdapter(){
        String defendClass = "android.support.v7.widget.RecyclerView$Adapter";
        ArrayList<String> methods = new ArrayList<String>();
        methods.add("onBindViewHolder");
        autoDefendClassMethods.put(defendClass, methods);
    }
